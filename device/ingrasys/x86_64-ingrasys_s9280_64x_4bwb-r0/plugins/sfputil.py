...
class SfpUtil(SfpUtilBase):
    ...
    CHECK_INTERVAL = 3    # presence check interval
    ...
    def __init__(self):
        ...
        for x in range(self.port_start, self.port_end + 1):
            ...
            port_eeprom_path = eeprom_path.format(phy_port + self.EEPROM_BUS_ID_BASE, self.EEPROM_I2C_ADDR)
