...
INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE_VERSION = 1.1.0

export INGRASYS_S9180_32X_PLATFORM_MODULE_VERSION
export INGRASYS_S9280_64X_PLATFORM_MODULE_VERSION
export INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE_VERSION
...
INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE = sonic-platform-ingrasys-s9280-64x-4bwb_$(INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE_VERSION)_amd64.deb
$(INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE)_PLATFORM = x86_64-ingrasys_s9280_64x_4bwb-r0
$(eval $(call add_extra_package,$(INGRASYS_S9180_32X_PLATFORM_MODULE),$(INGRASYS_S9280_64X_4BWB_PLATFORM_MODULE)))
